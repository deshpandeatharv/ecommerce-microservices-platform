...
import com.app.ecommerce.userservice.config.AppConstants;
import com.app.ecommerce.userservice.payload.AuthenticationResult;
...
import com.app.ecommerce.userservice.service.AuthService;
...
public class AuthController {
    ...
    public ResponseEntity<?> signoutUser(){
        Cookie cookie = authService.logoutUser();
        return ResponseEntity.ok().header(HttpHeaders.SET_COOKIE,
                        cookie.toString())
    ...
    @GetMapping("/ValidateUserForExternalService")
    public ResponseEntity<?> validateUserForExternalService(Authentication authentication){
        return ResponseEntity.ok().body(authService.validateUserForExternalService(authentication));
    }
